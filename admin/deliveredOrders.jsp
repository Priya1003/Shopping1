...
<table id="customers">
      ...
      try{
        	...
        	ResultSet rs=st.executeQuery("select * from orders inner join product where orders.product_id=product.id and orders.orderDate is not null and orders.status='Delivered'");
